<template>
  <div
    :class="['zebra-doc-content', `zebra-doc-content--${currentPage}`]"
    @click="onClick"
  >
    <slot />
  </div>
...
<style lang="scss">
.zebra-doc-card {
  margin-bottom: var(--zebra-doc-padding);
  ...
  > table {
    ...
    td {
      padding: 8px;
      border-top: 1px solid var(--zebra-doc-border-color);
    ...
    em {
      ...
      color: var(--zebra-doc-green);
      font-size: 14px;
      font-family: var(--zebra-doc-code-font-family);
      font-style: normal;
      max-width: 300px;
      -webkit-font-smoothing: auto;
    }
  ...
  > blockquote {
    ...
    font-size: 15px;
    line-height: 26px;
    color: var(--zebra-doc-blockquote-color);
    background-color: var(--zebra-doc-blockquote-background);
    border-radius: var(--zebra-doc-border-radius);
  }
